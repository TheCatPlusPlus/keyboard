...
*
* History:
* KBDTOOL v3.40 - Created  Tue Jul 09 17:53:35 2024
\***************************************************************************/
...
//                      |=========|=========|=========|=========|=========|
  ...
  {'4'          ,0      ,'4'      ,'$'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  ...
  {VK_OEM_PLUS  ,0      ,'='      ,'+'      ,WCH_NONE ,0x2248   ,0x2260   },
  {'Q'          ,CAPLOK ,'q'      ,'Q'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'W'          ,CAPLOK | CAPLOKALTGR,'w'      ,'W'      ,WCH_NONE ,0x03b5   ,0x0395   },
  {'E'          ,CAPLOK | CAPLOKALTGR,'e'      ,'E'      ,WCH_NONE ,0x0119   ,0x0118   },
  {'R'          ,CAPLOK | CAPLOKALTGR,'r'      ,'R'      ,WCH_NONE ,0x03b1   ,0x0391   },
  {'T'          ,CAPLOK | CAPLOKALTGR,'t'      ,'T'      ,WCH_NONE ,0x03c8   ,0x03a8   },
  {'Y'          ,CAPLOK | CAPLOKALTGR,'y'      ,'Y'      ,WCH_NONE ,0x03bb   ,0x039b   },
  {'U'          ,CAPLOK ,'u'      ,'U'      ,WCH_NONE ,0x20ac   ,WCH_NONE },
  {'I'          ,CAPLOK | CAPLOKALTGR,'i'      ,'I'      ,WCH_NONE ,0x03bc   ,0x039c   },
  {'O'          ,CAPLOK | CAPLOKALTGR,'o'      ,'O'      ,WCH_NONE ,0x00f3   ,0x00d3   },
  {'P'          ,CAPLOK | CAPLOKALTGR,'p'      ,'P'      ,WCH_NONE ,0x03c0   ,0x03a0   },
  {VK_OEM_4     ,0      ,'['      ,'{'      ,WCH_NONE ,0x221e   ,WCH_NONE },
  {VK_OEM_6     ,0      ,']'      ,'}'      ,WCH_NONE ,0x2200   ,0x2203   },
  {'A'          ,CAPLOK | CAPLOKALTGR,'a'      ,'A'      ,WCH_NONE ,0x0105   ,0x0104   },
  {'S'          ,CAPLOK | CAPLOKALTGR,'s'      ,'S'      ,WCH_NONE ,0x015b   ,0x015a   },
  {'D'          ,CAPLOK | CAPLOKALTGR,'d'      ,'D'      ,WCH_NONE ,0x03b4   ,0x0394   },
  {'F'          ,CAPLOK ,'f'      ,'F'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'G'          ,CAPLOK | CAPLOKALTGR,'g'      ,'G'      ,WCH_NONE ,0x03b3   ,0x0393   },
  {'H'          ,CAPLOK | CAPLOKALTGR,'h'      ,'H'      ,WCH_NONE ,0x03c3   ,0x03a3   },
  ...
  {VK_OEM_7     ,0      ,'\''     ,'\"'     ,WCH_NONE ,0x2032   ,0x2033   },
  {VK_OEM_3     ,0      ,'`'      ,'~'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_5     ,0      ,'\\'     ,'|'      ,WCH_NONE ,0x2208   ,0x2205   },
  {'Z'          ,CAPLOK | CAPLOKALTGR,'z'      ,'Z'      ,WCH_NONE ,0x017c   ,0x017b   },
  {'X'          ,CAPLOK | CAPLOKALTGR,'x'      ,'X'      ,WCH_NONE ,0x017a   ,0x0179   },
  {'C'          ,CAPLOK | CAPLOKALTGR,'c'      ,'C'      ,WCH_NONE ,0x0107   ,0x0106   },
  {'V'          ,CAPLOK ,'v'      ,'V'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'B'          ,CAPLOK | CAPLOKALTGR,'b'      ,'B'      ,WCH_NONE ,0x03b2   ,0x0392   },
  {'N'          ,CAPLOK | CAPLOKALTGR,'n'      ,'N'      ,WCH_NONE ,0x0144   ,0x0143   },
  {'M'          ,CAPLOK | CAPLOKALTGR,'m'      ,'M'      ,WCH_NONE ,0x03c9   ,0x03a9   },
